...
namespace ProjectScore
{
    ...
    {
        XmlDocument doc;
        public FormMidterm(XmlDocument document)
        {
            InitializeComponent();
            doc = document;
        }
        ...
        private void FormMidterm_Load(object sender, EventArgs e)
        {
            XmlNode node = doc.SelectSingleNode("class/自评互评教师评综合权重/期中考核/自评互评/权重");
